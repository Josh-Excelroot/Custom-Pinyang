...
Odoo filter purchase order 
         ...
         """,
    'summary': 'odoo App will show Partial Shipment,Partial Invoice, shipped, Invocied Status on Purchase Order | purchase invoice status | purchase shipment status | purchase vendor bill status | partial shipment status | partial invoice status | purchase order status | purchase status | quotation status | Partial Ship Status | Shipped | Partial Invoice Purchase | Invoiced Purchase | Purchase shipment status',

...
#kashif 2aug23: added code to get exchange rate and computr currency amount
    ...
    def _get_amount_rate(self):
        if self.company_id.currency_id != self.currency_id:
            ...
            self.manual_converted_amount = float_round(self.amount_total * self.exchange_rate_inverse,
    ...
    @api.onchange('company_id', 'currency_id','date_invoice')
    ...
    def action_move_create(self):
        ...
        for inv in self:
            ...
            total, total_currency, iml = inv.with_context(date=self.date_invoice,

...
class ResConfigSettings(models.TransientModel):
    ...
    vendor_payment_approval = fields.Boolean("Vendor Payment Approval", related='company_id.vendor_payment_approval', readonly=False)
    vendor_payment_amount = fields.Monetary(related='company_id.vendor_payment_amount', string="Vendor Payment Minimum Amount", readonly=False)
    vendor_payment_user_ids = fields.Many2many('res.users', related='company_id.vendor_payment_user_ids',
                                               readonly=False, string="Vendor Payment Users")

    invoice_notification_user_ids = fields.Many2many('res.users', related='company_id.invoice_notification_user_ids',
                                                     readonly=False, string="Invoice Approval Notification Recipients")
    bill_notification_user_ids = fields.Many2many('res.users', related='company_id.bill_notification_user_ids',
                                                  readonly=False, string="Bill Approval Notification Recipients")
    invoice_cn_notification_user_ids = fields.Many2many('res.users', related='company_id.invoice_cn_notification_user_ids',
                                                        readonly=False, string="Invoice CN Approval Notification Recipients")
    bill_cn_notification_user_ids = fields.Many2many('res.users', related='company_id.bill_cn_notification_user_ids',
                                                 readonly=False, string="Bill CN Approval Notification Recipients")

                    ...
                    if partner_template.complex_line:
                        ...
                        for temp_name in temp_names:
                            ...
                            if not check_price:
                                ...
                                if not product:
                                    product_ids = self.get_product_mapping_lines(product_keywords.id, product_name, direction, container_size, partner_template.partner_id.id)
                        ...
                        if quantity < 1000:
                            if product:
                                if partner_template.name in ['MEDITERRANEAN SHIPPING COMPANY (IDR)',
                                    ...
                                    line_amount_total = float_round(price * quantity * (currency_rate or 1), 2, rounding_method='HALF-UP') or 0.0

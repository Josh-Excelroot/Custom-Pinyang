...
class InsPartnerInvoiceXlsx(models.AbstractModel):
    ...
    def prepare_report_contents(self, data, acc_lines, filter):
        ...
        self.sheet.write_string(self.row_pos, 5, _('Reconciled?'),
                                self.format_header)
        self.sheet.write_string(self.row_pos, 6, _('Curr.'), self.format_header)
        self.sheet.write_string(self.row_pos, 7, _('Original Amount'),
                                self.format_header)
        self.sheet.write_string(self.row_pos, 8, filter.get('company_currency_name'), self.format_header)
        self.sheet.write_string(self.row_pos, 9, _('Reconciled Amount'),
                                self.format_header)
        self.sheet.write_string(self.row_pos, 10, filter.get('company_currency_name'), self.format_header)
        self.sheet.write_string(self.row_pos, 11, _('Unreconciled Amount'),
                                self.format_header)
        self.sheet.write_string(self.row_pos, 12, filter.get('company_currency_name'), self.format_header)
        ...
        if acc_lines:
            for line in acc_lines:
                ...
                self.sheet.write_string(self.row_pos, 2, line.get('partner_name', ''), self.line_header_left)
                ...
                self.sheet.write_string(self.row_pos, 6, line.get('currency_name'), self.line_header)
                self.sheet.write_number(self.row_pos, 7, line.get('amount_currency'), self.line_header)
                self.sheet.write_number(self.row_pos, 8, line.get('amount_company_currency'), self.line_header)
                self.sheet.write_number(self.row_pos, 9, line.get('amount_currency') - line.get('amount_unreconciled'), self.line_header)
                self.sheet.write_number(self.row_pos, 10, line.get('amount_company_currency') - line.get('amount_unreconciled_company_currency'), self.line_header)
                self.sheet.write_number(self.row_pos, 11, line.get('amount_unreconciled'), self.line_header)
                self.sheet.write_number(self.row_pos, 12, line.get('amount_unreconciled_company_currency'), self.line_header)
                ...
                self.sheet.write_string(self.row_pos, 5, _('Analytic Tags'),
                                        self.format_header)
                self.sheet.write_string(self.row_pos, 7, _('Doc Amount'),
                                        self.format_header)
                self.sheet.write_string(self.row_pos, 9, _('Knock-off Amount'),
                                        self.format_header)
                for sub_line in sub_lines:
                    ...
                    #                         self.line_header_light)
                    self.sheet.write_number(self.row_pos, 7, sub_line.get('doc_amount','0'),
                                            self.line_header_light)
                    self.sheet.write_number(self.row_pos, 9, sub_line.get('knock_off_amount','0') or 0,
                                            self.line_header_light)
    ...
    def generate_xlsx_report(self, workbook, data, record):
        ...
        self.sheet.set_column(2, 2, 40)
        self.sheet.set_column(3, 3, 18)
        self.sheet.set_column(4, 4, 25)
        self.sheet.set_column(5, 5, 18)
        self.sheet.set_column(6, 6, 5)
        self.sheet.set_column(7, 7, 19)
        self.sheet.set_column(8, 8, 13)
        self.sheet.set_column(9, 9, 19)
        self.sheet.set_column(10, 10, 13)
        self.sheet.set_column(11, 11, 19)
        self.sheet.set_column(12, 12, 13)

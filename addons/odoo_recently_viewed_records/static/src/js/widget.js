odoo.define('odoo_recently_viewed_records.widget', function (require) {
    ...
    var RecentRecord = Widget.extend({
        ...
        _onRecordFilterClick: function(event) {
            ...
            var context = {};
//            kashif 25may23 : for account view which has issue
            if (data.res_model == 'account.invoice' || data.res_model == 'account.move' || data.res_model == 'account.payment' || data.res_model ==  'account.voucher'){

odoo.define('alan_customize.customs_shop_js', function(require){
    ...
    $(document).on('click', '#load_more_products', function(){
        ...
        if($("form.js_attributes").length > 0){
            ...
            $("form.js_attributes ul input[name*='brands']").each(function(){
                if($(this).is(':checked')){
    ...
    $(document).ready(function(){
        ...
        if ($("li.pro_clear").find('.collapsible_attr_name').length == 1){ 
            $('#tag_name').attr("style", "display: none;"); 
        } else {
            $('#tag_name').removeAttr("style");
        }
        if ($("li.brand_clear").find('.collapsible_attr_name').length == 1){ 
            $('#brand_name').attr("style", "display: none;"); 
        } else {
            $('#brand_name').removeAttr("style");
        }
        ...
        $("#products_grid_before .js_attributes .clear_attr_filter").on("click", function(e){
            ...
            $attr_box.find("input[name='brands']").each(function(){
                $(this).removeAttr('checked');
            });

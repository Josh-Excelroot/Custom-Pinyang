...
//            self.ks_fetch_data();
        ...
        events: {
            ...
            'click .ks_stop_prop': 'ksStopProp',
        },

        ksStopProp: function(ev){
            ev.preventDefault();
            ev.stopPropagation()
        },
...
//                result = self.normalize_dn_data(result);
        ...
        _renderGraph: function(item) {
            ...
            var $ks_gridstack_container = $(QWeb.render('ks_gridstack_container', {
                ...
                ks_show_records: item.ks_show_records,
                ks_query_type: item.ks_data_calculation_type,

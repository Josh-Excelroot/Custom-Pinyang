...
class BOLXlsx(models.AbstractModel):
    _name = 'report.sci_goexcel_freight_2.report_bol_xls'
    ...
    def generate_xlsx_report(self, workbook, data, lines):
        ...
        if lines.direction == 'export':
            ...
            if lines.carrier_booking_no:
                sheet.write(1, 5, lines.bol_no, format2)
            #Row 3
            ...
            feeder_vessel_name = ''
            feeder_voyage_no = ''
            if lines.pre_carriage_by:
                feeder_vessel_name = lines.pre_carriage_by
            if lines.feeder_voyage:
                feeder_voyage_no = lines.feeder_voyage
            ...
            if lines.port_of_loading_input:
                sheet.write(20, 6, lines.port_of_loading_input, format1)
            #Row 22
            ...
            if lines.port_of_discharge_input:
                sheet.write(21, 2, lines.port_of_discharge_input, format1)

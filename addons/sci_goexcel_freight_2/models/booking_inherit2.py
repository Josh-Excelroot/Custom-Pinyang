...
class FreightBooking2(models.Model):
    ...
    def create(self, vals):
        ...
        print('Create SAJJAD',template,company,bc_sale_term)
...
class FreightOperationLine3(models.Model):
    ...
    def create(self, vals):
        ...
        return super(FreightOperationLine3, self).create(vals)
...
class CostProfit(models.Model):
    ...
    def set_tax_value(self):
        for rec in self:
            ...
            partner_source_tax = partner_fiscal_position.tax_ids.tax_src_id
            partner_replacement_tax = partner_fiscal_position.tax_ids.tax_dest_id
